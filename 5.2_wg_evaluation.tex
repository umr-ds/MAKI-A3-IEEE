...
The first 50 seconds are used to allow the emulation establish routes throughout the network.%, so that packets can be routed from client to server and back again.
